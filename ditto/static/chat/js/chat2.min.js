define(["exports", "module", "react", "vendor/react-bootstrap/index", "chat/js/chat.min"], function (exports, module, _react, _vendorReactBootstrapIndex, _chatJsChatMin) {
			...
			Chat.connect(chatConf.server, chatConf.me, chatConf.password);
			...
			var render = function render() {
						React.render(React.createElement(ChatApp, { server: chatConf.server, me: chatConf.me, password: chatConf.password, other: chatConf.other, chatroom: chatConf.chatroom, nick: chatConf.nick, page: chatConf.page }), document.getElementById(chatConf.element));
			};
