define(["exports", "module"], function (exports, module) {
								...
								checkImStillTyping: function checkImStillTyping() {
												if (composedMessageChangeAt) {
																...
																if (now - composedMessageChangeAt > stillTypingTimeout) {
																				...
																				connection.chatstates.sendActive(Strophe.getBareJidFromJid(this.state.talkingTo));
																} else {
				...
				var render = function render() {
								React.render(React.createElement(Chat, { server: chatConf.server, me: chatConf.me, password: chatConf.password, other: chatConf.other, chatroom: chatConf.chatroom, nick: chatConf.nick }), document.getElementById("chat"));
				};
