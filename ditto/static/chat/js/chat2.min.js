define(["exports", "module", "react", "vendor/react-bootstrap/index", "chat/js/chat.min"], function (exports, module, _react, _vendorReactBootstrapIndex, _chatJsChatMin) {
			...
			var ChatApp = React.createClass({
						...
						componentDidMount: function componentDidMount() {
									...
									this.listener = Visibility.change(function (e, state) {
												var messages = getMessages(_this.state.chat.messages, _this.state.talkingTo);
												_this.markMessagesRead(messages);
												_this.setState({ isHidden: Visibility.hidden() });
									});
						},
						...
						markMessagesRead: function markMessagesRead(messages) {
						...
						render: function render() {
									...
									if (this.state.isHidden || this.props.page !== "messages") {
												this.state.chat.messages.forEach(function (message) {
															if (message.from !== Strophe.getNodeFromJid(chatConf.me) && !message.isRead && notified.indexOf(message.id) === -1) {
									...
									if (this.state.chat.connectionStatus !== "connected") {
												...
												return React.createElement(
															...
															React.createElement(
																		...
																		React.createElement(WhosTyping, { users: this.state.chat.whosTyping }),
																		React.createElement(
																					"div",
																					{ className: "row msgbar" },
																					React.createElement(ComposeMessage, { onMessageSubmit: this.handleMessageSubmit, onMessageChange: this.handleMessageChange }),
																					React.createElement(MyStatus, { setStatus: Chat.setStatus })
																		)
															)
												);
									} else {
									...
									var users = this.props.users.map(function (user, i) {
												return React.createElement(
															...
															React.createElement(
																		...
																		user,
																		" (",
																		React.createElement(Role, { user: user }),
																		")"
															)
												);
									});
															...
															React.createElement(
																		...
																		React.createElement(
																					...
																					React.createElement(
																								...
																								this.props.from,
																								" (",
																								React.createElement(Role, { user: this.props.from }),
																								") ",
																								React.createElement(
																											"small",
																											null,
			...
			var ChangeAvatar = React.createClass({
						...
						render: function render() {
									var avatars = this.getAvatars().map(function (avatar) {
												...
												return React.createElement(
															"li",
															{ key: avatarName },
															React.createElement("a", { onClick: changeAvatar, dangerouslySetInnerHTML: { __html: avatar[1] }, href: "#" })
												);
									});
									return React.createElement(
												"div",
			...
			var ChatroomModule = React.createClass({
						...
						render: function render() {
									...
									return React.createElement(Messages, { fixedHeight: true, messages: messages });
						}
			});
			...
			var NewMessageCount = React.createClass({
						...
						render: function render() {
									var unread = this.state.messages.filter(function (m) {
												return !m.isRead;
									}).length;
									if (unread) {
												return React.createElement(
			...
			var render = function render() {
						...
						React.render(React.createElement(ChatApp, { me: chatConf.me, other: chatConf.other, page: chatConf.page }), chat || document.getElementById("emptychat"));
						React.render(React.createElement(NewMessageCount, null), document.getElementById("new-message-count"));
						if (whosonline) {
									React.render(React.createElement(WhosOnline, null), whosonline);
						};
						if (chatroomModule) {
									React.render(React.createElement(ChatroomModule, null), chatroomModule);
						}
						if (profileAvatar) {
									var name = profileAvatar.dataset.name;
									React.render(React.createElement(Avatar, { user: name, size: 100 }), profileAvatar);
									React.render(React.createElement(ChangeAvatar, { user: name }), document.getElementById("change-avatar"));
						}
						React.render(React.createElement(Avatar, { user: Strophe.getNodeFromJid(chatConf.me), size: 50 }), document.getElementById("nav-avatar"));
			};
