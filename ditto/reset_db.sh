...
MAILGUN_USERNAME=x MAILGUN_PASSWORD=x DJANGO_TENANT=di python manage.py migrate
MAILGUN_USERNAME=x MAILGUN_PASSWORD=x DJANGO_TENANT=di python manage.py runscript setup_test_data
